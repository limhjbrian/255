...
scene.setBackgroundImage(img`
    ...
    ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    `)
tiles.setCurrentTilemap(tilemap`starting lobby1`)
...
game.onUpdateInterval(100, function () {
    if (roomNum == 0) {
        ...
        if (mySprite.tileKindAt(TileDirection.Center, sprites.swamp.swampTile14) || mySprite.tileKindAt(TileDirection.Center, sprites.swamp.swampTile5) || (mySprite.tileKindAt(TileDirection.Center, sprites.swamp.swampTile9) || mySprite.tileKindAt(TileDirection.Center, sprites.swamp.swampTile8))) {
            mySprite.x += 4
        }
        ...
        if (mySprite.tileKindAt(TileDirection.Bottom, sprites.builtin.oceanSand0) || (mySprite.tileKindAt(TileDirection.Bottom, sprites.builtin.oceanSand1) || mySprite.tileKindAt(TileDirection.Bottom, sprites.builtin.oceanSand3))) {
            scene.setBackgroundImage(img`
                
        ...
        if (mySprite.tileKindAt(TileDirection.Bottom, sprites.dungeon.greenOuterNorthWest) || mySprite.tileKindAt(TileDirection.Bottom, sprites.dungeon.greenOuterNorth0) || (mySprite.tileKindAt(TileDirection.Bottom, sprites.dungeon.greenOuterNorth1) || mySprite.tileKindAt(TileDirection.Bottom, sprites.dungeon.greenOuterNorthEast))) {
            scene.setBackgroundImage(img`
                
        ...
        if (mySprite.tileKindAt(TileDirection.Center, sprites.dungeon.collectibleRedCrystal)) {
            ...
            game.setDialogTextColor(7)
            game.showLongText("Game by Brian Lim", DialogLayout.Bottom)
            game.showLongText("Thanks Olivia and Harry", DialogLayout.Bottom)
            game.showLongText("Inspired by Minedapple's 256", DialogLayout.Bottom)
